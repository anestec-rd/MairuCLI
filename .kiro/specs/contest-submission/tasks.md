...
- [x] 3.1 Document Kiro Workflow and Features
  ...
  - Document Hooks usage (if applicable)
  - Include examples from MairuCLI development
  - Show how these features contributed to 7.5-9x productivity
  - Add overview section to README.md linking to detailed doc
  - _Requirements: 1.1, 3.5_
  - _Time: 45-60 minutes_
